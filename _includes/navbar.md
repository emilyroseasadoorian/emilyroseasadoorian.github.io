<nav id="navbar" class="bg-body w-100 sticky-top py-2 border-bottom border-primary">
    <a href="{{ site.url }}{{ site.baseurl }}/index" title="Home" class="me-1"><i class="bi-house-heart"></i></a>
    {% if page.url == "/index" %}<a href="javascript:void(0)" id="searchIcon" title="Search Details" class="me-1"><i class="bi-search"></i></a>
